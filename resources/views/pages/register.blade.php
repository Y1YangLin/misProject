...
<head>
  ...
  <link href="{{ asset('login_assets/images/favicon.ico') }}" rel="shortcut icon" type="image/x-icon">
  <link href="{{ asset('login_assets/images/webclip.png') }}" rel="apple-touch-icon">
</head>
<body>
  ...
  <div class="waves---section-medium-3">
    <div class="waves-master-contact-1">
      <div class="waves---center-heading">
        ...
        <div class="waves---paragraph-big-2">Welcome to YOFU, here is the registeration page.</div>
      </div>
      <div class="waves-form-block-contact-1 w-form">
        <form id="wf-form-Contact-Form" name="wf-form-Contact-Form" data-name="Contact Form" method="get" class="waves---form-contact-2" data-wf-page-id="64d0d9ef449eb28e9c7d0e81" data-wf-element-id="4e969231-cb0b-30b7-3799-4576ee8a44bd">
