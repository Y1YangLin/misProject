...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/bootstrap/css/Hero-Carousel-images.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/bootstrap/css/Navbar-Right-Links-Dark-icons.css') }}">
...
<body>
        ...
        <div class="container-fluid" style="padding: 0px;">
            <div class="carousel slide" data-bs-ride="carousel" id="carousel-1" style="height: 600px;">
                <div class="carousel-inner h-100">
                    <div class="carousel-item active h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="{{ asset('assets/bootstrap/img/banner4.jpg') }}" alt="Slide Image" style="z-index: -1;/*width: 800px;*/">
                    ...
                    <div class="carousel-item h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="assets/bootstrap/img/banner5.jpg" alt="Slide Image" style="z-index: -1;">
                    ...
                    <div class="carousel-item h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="assets/bootstrap/img/banner6.jpg" alt="Slide Image" style="z-index: -1;">
                        <div class="container d-flex flex-column justify-content-center h-100">
                            <div class="row">
                                <div class="col-md-6 col-xl-4 offset-md-2">
                                    <div style="max-width: 350px;">
    ...
    <section class="d-xxl-flex justify-content-xxl-center align-items-xxl-center" style="background: white;height: 1200px;font-size: 16px;min-height: auto;">
        <div class="container d-xxl-flex justify-content-xxl-center">
            <div class="row g-0 d-xxl-flex justify-content-center align-items-center justify-content-xxl-center" style="height: 300px;">
                <div class="col-md-4 col-xxl-6 offset-xxl-0" style="background: var(--bs-body-bg);padding: 0px;padding-left: 0px;margin: 20px 50px;width: 320px;height: 367.2px;"><img src="assets/bootstrap/img/clipboard-image-1.png" style="margin: -1px;width: 321px;height: auto;" width="244" height="136">
                ...
                <div class="col-md-4" style="background: var(--bs-body-bg);width: 320px;padding: 0px;height: 367.2px;margin: 20px 50px;"><img src="assets/bootstrap/img/clipboard-image-2.png" style="width: 321px;margin: -1px;height: auto;" width="350" height="195">
                ...
                <div class="col-md-4" style="background: #FFFFFF;width: 320px;padding: 0px;height: 367.2px;margin: 20px 50px;"><img src="assets/bootstrap/img/clipboard-image-3.png" style="width: 321px;margin: -1px;height: auto;">
    ...
    <section style="background: var(--bs-body-bg);">
        ...
        <div class="container" style="padding-bottom: 100px;">
            <div class="row">
                <div class="col-md-6 mx-auto"><img src="assets/bootstrap/img/photograph.png"></div>
        ...
        <div class="container" style="padding-bottom: 100px;">
            <div class="row">
                ...
                <div class="col-md-6"><img src="assets/bootstrap/img/pic2.png"></div>
            </div>
        </div>
        <div class="container" style="padding-bottom: 100px;">
            <div class="row">
                <div class="col-md-6"><img src="assets/bootstrap/img/pic3.png"></div>
        ...
        <div class="container" style="padding-bottom: 100px;">
            <div class="row">
                ...
                <div class="col-md-6"><img src="assets/bootstrap/img/pic.png"></div>
            </div>
        </div>
        <div class="container" style="padding-bottom: 100px;">
            <div class="row">
                <div class="col-md-6"><img src="assets/bootstrap/img/pic4.png" style="width: 550px;"></div>
        ...
        <div class="container-fluid" style="background: #F5F3E9;">
            <div class="row g-0">
                <div class="col-md-6 text-center align-self-center" style="background: #F5F3E9;">
                    <h1 style="color: #000;font-family: Hind;font-weight: bold;font-size: 32px;">立即體驗，體驗前請先加入會員</h1>
                       
                    <a href="/facetype/photo">
                        <button class="btn btn-primary" type="button" style="color: #FFF;font-weight: bold;text-align: center;font-size: 18px;font-family: Hind;background: #000000;border-radius: 50px;padding: 12px 89px;">立即體驗</button>
                    </a>
                    
                </div>
                <div class="col-md-6 text-center align-self-center" style="background: #F5F3E9;">
                    <img src="assets/bootstrap/img/banner7.jpg">
                </div>
