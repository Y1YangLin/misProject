...
<head>
    ...
    <title>問卷調查</title>
    <link rel="stylesheet" href="{{ URL::asset('question_assets/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('question_assets/css/aos.min.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('question_assets/css/Features-Cards-icons.css') }}>
    <link rel="stylesheet" href="{{ URL::asset('question_assets/css/Footer-with-social-media-icons.css') }}">
</head>
...
<body class="text-bg-dark">
    ...
    <section>
        <div data-bss-parallax-bg="true" style="height: 600px;background-image: url({{ URL::asset('question_assets/img/beauty-products-and-makeup-on-black-background.jpg') }});background-position: center;background-size: cover;margin-top: -10px;padding-bottom: 0px;margin-bottom: 0px;"></div>
    </section>
        ...
        <div class="container py-4 py-lg-5" style="margin-top: 54px;">
            ...
            <div class="d-flex justify-content-between align-items-center pt-3">
                ...
                <ul class="list-inline mb-0">
                    ...
                    <li class="list-inline-item list-inline-item"><a class="btn" type="button" href = "/Admins/login"><i class="far fa-user text-light" style="height: 16px;width: 16px;"></i></a></li>
                </ul>
            </div>
        </div>
    </footer>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <hr><img class="img-thumbnail" width="" height="auto" src="{{ URL::asset('question_assets/img/type.jpg') }}" style="max-width: 466px;">
                </div>
                <div class="modal-footer"><a class="btn btn-secondary" href="login_assets">關閉</a></div>
            </div>
        </div>
    </div>
    <div class="modal fade" role="dialog" tabindex="-1" id="Model-Rewrite" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer"><button class="btn btn-secondary" type="button" data-bs-dismiss="modal">關閉</button><a class="btn btn-secondary" href="users/q">確定</a></div>
            </div>
        </div>
    </div>
    ...
    <script src="{{ URL::asset('question_assets/bootstrap/js/bootstrap.min.js') }}"></script>
    <script src="{{ URL::asset('question_assets/js/aos.min.js') }}"></script>
    <script src="{{ URL::asset('question_assets/js/bs-init.js') }}"></script>
    <script src="{{ URL::asset('question_assets/js/button.js') }}"></script>
