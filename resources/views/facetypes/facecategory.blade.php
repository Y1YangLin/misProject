        ...
        <div class="container-fluid" style="background: #F5F3E9;">
            <div class="row g-0">
                <div class="col-md-6 text-center align-self-center" style="background: #F5F3E9;">
                    <h1 style="color: #000;font-family: Hind;font-weight: bold;font-size: 32px;">立即體驗，體驗前請先加入會員</h1><a href="/facetype/photo"><button class="btn btn-primary" type="button" style="color: #FFF;font-weight: bold;text-align: center;font-size: 18px;font-family: Hind;background: #000000;border-radius: 50px;padding: 12px 89px;">立即體驗</button></a>
                </div>
                <div class="col-md-6 text-center align-self-center" style="background: #F5F3E9;">
