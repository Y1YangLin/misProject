...
<head>
  ...
  <link href="product_assets/css/normalize.css" rel="stylesheet" type="text/css">
  <link href="product_assets/css/webflow.css" rel="stylesheet" type="text/css">
  <link href="product_assets/css/waves-library-site-e37884.webflow.css" rel="stylesheet" type="text/css">
  ...
  <link href="product_assets/images/favicon.ico" rel="shortcut icon" type="image/x-icon">
  ...
  "group": ""
            ...
            <div class="columns w-row">
              <div class="w-col w-col-4">
                <a href="#" class="lightbox-link w-inline-block w-lightbox"><img srcset="product_assets/images/02-blog-images-elements-brix-templates-p-500.jpg 500w, product_assets/images/02-blog-images-elements-brix-templates-p-800.jpg 800w, product_assets/images/02-blog-images-elements-brix-templates-p-1080.jpg 1080w, product_assets/images/02-blog-images-elements-brix-templates.jpg 1758w" id="picture" sizes="(max-width: 479px) 51vw, (max-width: 767px) 28vw, (max-width: 991px) 27vw, (max-width: 1439px) 13vw, (max-width: 1919px) 15vw, 16vw" src="product_assets/images/02-blog-images-elements-brix-templates.jpg" alt="Blog - Elements Webflow Library - BRIX Templates" class="brix---blog-card-image-featured">
                  <script type="application/json" class="w-json">{
  "items": [
    {
      "_id": "example_img",
          ...
          <div id="w-node-_3ffd1ac0-85be-253c-d63c-f6e903ae0f98-9be527bc" class="brix---blog-card-featured-content">
            <div class="brix---mg-bottom-8px">
              <div class="brix---color-neutral-807">
                <h2 class="brix---heading-h2-size-2">Product&#x27;s name</h2>
              </div>
            </div>
            <div class="brix---mg-bottom-32px">
              <div class="brix---color-neutral-804">
                <p class="brix---paragraph-default-2">Lorem ipsum dolor sit amet conse ctetur adip iscing elit justo quis odio sit sit ac port titor sit males dolor sit consectur dolor.</p>
              </div>
            </div>
          ...
          <a data-w-id="eb709af1-e72b-d2f2-2b51-512266f37905" href="#" class="brix---blog-card-wrapper w-inline-block">
            ...
            <div>
              ...
              <div class="brix---color-neutral-806">
                <h3 class="brix---heading-h3-size-2">NAME</h3>
              </div>
              <div class="brix---color-neutral-804">
                <p class="brix---paragraph-default-2">Lorem ipsum dolor sit amet conse ctetur adip iscing elit justo quis odio sit sit ac port titor sit males dolor sit consectur dolor.</p>
              </div>
